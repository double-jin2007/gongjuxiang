...
class ToolController extends BaseController
{
    ...
    public function createAction(){
        if($this->request->isPost()){
            ...
            $systemList = ['tp_admin','tp_admin_role','tp_admin_struct','tp_config','tp_loginlog','tp_menu','tp_notice','tp_role','tp_role_menu','tp_role_struct','tp_struct','tp_wechat_users','tp_wechat_access','tp_smscode','demo_media'];
